...
public final class Field {
    ...
    public static void gameOverScreenAlpha() {
    ...
    public static void gameOverScreenBeta() {
        ...
        while (true) {
            ...
            waitingTime(200);
            normalWriting(gameOver, Terminal.Color.RED);
            firstTime = false;
    ...
    private static void normalWritingOldCode(String gameOver, Terminal.Color color) {
        int index = 0;
        int gameOverY = 9;
